...
public class BeastBerry extends Berry {
    ...
    public void strongEffect(LivingEntity target) {
        //give consumer HUNGER 160 !!!! for 1 second :p
        //honnggrrryyyyy (reduces saturation by 4, for a net total of +2.4-4= -1.6 saturation overall)
        //this berry makes you hungrier than before you ate it...
        target.addStatusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 20, 159));
